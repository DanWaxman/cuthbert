...
The computation of $J_t$ involves the ensemble of $x_{t+1 \mid t}$; to avoid duplicate computation, the EnRTS therefore requires `store_predicted_ensmeble=True` in the forward filtering run.
